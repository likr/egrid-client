...
(function (egrid) {
    (function (app) {
        var ProjectController = (function () {
            function ProjectController($q, $routeParams, $location, $scope) {
                var _this = this;
                this.$q = $q;
                this.$location = $location;
                this.$scope = $scope;
