angular.module('collaboegm').run(['$templateCache', function($templateCache) {
  ...
  $templateCache.put('/partials/participant-detail.html',
    "<div>\n" +
    "  <h2>{{participant.name}}</h2>\n" +
    "\n" +
    "  <ol class=\"breadcrumb\">\n" +
    "    <li>\n" +
    "      <a href=\"/#/projects\">{{ 'PROJECT.PROJECTS' | translate }}</a>\n" +
    "    </li>\n" +
    "    <li>\n" +
    "      <a href=\"/#/projects/{{participant.project.key}}\">{{participant.project.name}}</a>\n" +
    "    </li>\n" +
    "    <li class=\"active\">\n" +
    "      {{participant.name}}\n" +
    "    </li>\n" +
    ...
    "    </div>\n" +
    "\n" +
    "    <div tab heading=\"{{'EGM.EVALUATION_STRUCTURE' | translate}}\" select=\"drawSvg()\">\n" +
  ...
  $templateCache.put('/partials/project-detail.html',
    ...
    "\n" +
    "  <ol class=\"breadcrumb\">\n" +
    "    <li><a href ui-sref=\"projects.all\">{{'PROJECT.PROJECTS' | translate}}</a>\n" +
  ...
  $templateCache.put('/partials/project-list.html',
    "<div>\n" +
  ...
  $templateCache.put('/partials/sem-project-detail.html',
    "<div>\n" +
    "  <h2>{{ semProject.name }}</h2>\n" +
    "\n" +
    "  <ol class=\"breadcrumb\">\n" +
    ...
    "    </li>\n" +
    "    <li>\n" +
    "      <a href=\"/#/projects/{{semProject.project.key}}\">{{semProject.project.name}}</a>\n" +
    "    </li>\n" +
    "    <li class=\"active\">\n" +
    "      {{ semProject.name }}\n" +
    "    </li>\n" +
    ...
    "\n" +
    "  <div tabset>\n" +
    "    <div tab heading=\"{{ 'SEM.QUESTIONNAIRE.DESIGN' | translate }}\">\n" +
    "      <div ng-controller=\"SemProjectQuestionnaireEditController as questionnaire\">\n" +
    "        <h2>アンケート設定</h2>\n" +
    "        <form class=\"form-horizontal\">\n" +
    "          <div class=\"form-group\">\n" +
    "            <label class=\"col-sm-2 control-label\">アンケート題名</label>\n" +
    ...
    "    </div>\n" +
    "\n" +
    "    <div tab heading=\"{{'SEM.QUESTIONNAIRE.QUESTIONNAIRE' | translate}}\">\n" +
    "    </div>\n" +
    "\n" +
    "    <div tab heading=\"{{'SEM.ANALYSIS' | translate}}\" select=\"drawSemAnalysis()\">\n" +
    "      <div ng-controller=\"SemProjectAnalysisController as analysis\">\n" +
