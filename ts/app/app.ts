...
module egrid.app {
  angular.module('collaboegm', ['ngRoute', "ui.bootstrap", "pascalprecht.translate"])
    ...
    .controller('ParticipantGridEditController', ['$q', '$routeParams', '$location', '$dialog', '$scope', ParticipantGridEditController])
    ...
    .controller('ProjectGridController', ['$q', '$routeParams', '$dialog', '$scope', ProjectGridController])
