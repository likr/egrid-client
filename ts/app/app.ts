...
module egrid.app {
  angular.module('collaboegm', ['paginator', 'ui.router', "ui.bootstrap", "pascalprecht.translate"])
    ...
    .controller('CollaboratorListController',             ['$window', '$q',               '$stateParams', '$state', '$scope', '$modal',             CollaboratorListController])
    .controller('ParticipantController',                  ['$window', '$q',               '$stateParams', '$state', '$scope', '$modal',             ParticipantController])
    .controller('ParticipantCreateController',            ['$window', '$q',               '$stateParams', '$state',                                 ParticipantCreateController])
    .controller('ParticipantGridController',              ['$window', '$q',               '$stateParams',           '$scope',                       ParticipantGridController])
    .controller('ParticipantGridEditController',          ['$window', '$q',               '$stateParams', '$state', '$scope', '$modal',             ParticipantGridEditController])
    .controller('ParticipantListController',              ['$window', '$q',               '$stateParams',                                           ParticipantListController])
    .controller('ProjectController',                      ['$window', '$q',               '$stateParams', '$state', '$scope', '$modal',             ProjectController])
    ...
    .controller('ProjectGridEditController',              ['$window', '$q',               '$stateParams',           '$scope', '$modal',             ProjectGridEditController])
    .controller('ProjectGridListController',              ['$window', '$q',               '$stateParams',                                           ProjectGridListController])
    .controller('ProjectListController',                  ['$window', '$q', '$rootScope',                                                           ProjectListController])
    .controller('SemProjectController',                   ['$window', '$q',               '$stateParams',                                           SemProjectController])
    ...
    .controller('SemProjectListController',               ['$window', '$q',               '$stateParams', '$state',                                 SemProjectListController])
